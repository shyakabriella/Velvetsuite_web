...
export default function About() {
    return (
        <div className="overflow-x-hidden">
            ...
            <section className="bg-white py-12 px-6">
                <ScrollReveal>
                    <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-start">
                        ...
                        <div>
                            <img src="/aboutpage/image_4.jpg" alt="Mission" className="w-full h-auto object-cover block shadow-2xl rounded-sm" />
                        </div>
                    </div>
                </ScrollReveal>
            </section>
                ...
                <ScrollReveal>
                    <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-start">
                        <div className="order-2 md:order-1">
                            <img src="/aboutpage/image_5.jpg" alt="Vision" className="w-full h-[350px] md:h-[450px] object-cover block shadow-2xl rounded-sm" />
                        </div>
            ...
            {/* Chairman's Message */}
            <section className="bg-white pt-16 pb-16 md:pb-32 px-6">
                <ScrollReveal>
                    <div className="max-w-6xl mx-auto relative flex items-center">
                        {/* The Image */}
                        <div className="w-[100%] md:w-[65%]">
                            <img src="/aboutpage/image_6.jpeg" alt="Chairman" className="w-full h-[600px] md:h-[800px] object-cover block rounded-sm shadow-xl" />
                        </div>
                        
                        {/* The Black Box */}
                        <div className="md:absolute md:right-0 md:top-1/2 md:-translate-y-1/2 w-[100%] md:w-[50%] bg-[#0d0d0d] text-white p-10 md:p-14 shadow-2xl z-10 mt-[-50px] md:mt-0 relative rounded-sm">
            ...
            <section className="bg-[#faf9f6] py-20 px-6">
                <ScrollReveal>
                    <div className="max-w-5xl mx-auto">
                        <h3 className="text-[#333] text-[28px] md:text-[32px] mb-8 text-center" style={{ fontFamily: "'Marcellus', serif" }}>Meet Our Team</h3>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {/* Member 1 */}
                            <div className="relative group overflow-hidden rounded-md shadow-lg">
                                <img src="/aboutpage/image_7.jpg" alt="Mazimpaka Emmanuel" className="w-full aspect-[4/5] object-cover group-hover:scale-105 transition-transform duration-700" />
                                ...
                                <div className="absolute bottom-6 left-6 right-6 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                                    <p className="text-[#c9a84c] text-[9px] uppercase tracking-[0.15em] font-extrabold mb-1" style={{ fontFamily: "'Lato', sans-serif" }}>OPERATIONS MANAGER</p>
                                    <p className="text-white text-[17px] font-medium" style={{ fontFamily: "'Lato', sans-serif" }}>Mazimpaka Emmanuel</p>
                                </div>
                            </div>
                            {/* Member 2 */}
                            <div className="relative group overflow-hidden rounded-md shadow-lg">
                                <img src="/aboutpage/image_8.jpg" alt="Musabyimana Louise" className="w-full aspect-[4/5] object-cover group-hover:scale-105 transition-transform duration-700" />
                                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent opacity-80 group-hover:opacity-100 transition-opacity duration-300" />
                                <div className="absolute bottom-6 left-6 right-6 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                                    <p className="text-[#c9a84c] text-[9px] uppercase tracking-[0.15em] font-extrabold mb-1" style={{ fontFamily: "'Lato', sans-serif" }}>HEAD OF CUSTOMER CARE</p>
                                    <p className="text-white text-[17px] font-medium" style={{ fontFamily: "'Lato', sans-serif" }}>Musabyimana Louise</p>
                                </div>
                            </div>
                            {/* Member 3 */}
                            <div className="relative group overflow-hidden rounded-md shadow-lg">
                                <img src="/aboutpage/image_9.jpeg" alt="Uwamahoro Delphine" className="w-full aspect-[4/5] object-cover group-hover:scale-105 transition-transform duration-700" />
                                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent opacity-80 group-hover:opacity-100 transition-opacity duration-300" />
                                <div className="absolute bottom-6 left-6 right-6 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                                    <p className="text-[#c9a84c] text-[9px] uppercase tracking-[0.15em] font-extrabold mb-1" style={{ fontFamily: "'Lato', sans-serif" }}>RECEPTIONIST</p>
            ...
            <section className="bg-white py-24 px-6">
                <ScrollReveal>
                    <div className="max-w-5xl mx-auto">
                        <h3 className="text-[#333] text-[28px] md:text-[32px] mb-8 text-center" style={{ fontFamily: "'Marcellus', serif" }}>Board of Directors</h3>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {/* Board 1 */}
                            <div className="relative group overflow-hidden rounded-md shadow-lg">
                                <img src="/aboutpage/image_10.png" alt="Ally Gasana" className="w-full aspect-[4/5] object-cover group-hover:scale-105 transition-transform duration-700" />
                                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent opacity-80 group-hover:opacity-100 transition-opacity duration-300" />
                                <div className="absolute bottom-6 left-6 right-6 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                                    <p className="text-[#c9a84c] text-[9px] uppercase tracking-[0.15em] font-extrabold mb-1" style={{ fontFamily: "'Lato', sans-serif" }}>CHAIRMAN OF THE BOARD</p>
                                    <p className="text-white text-[17px] font-medium" style={{ fontFamily: "'Lato', sans-serif" }}>Ally Gasana</p>
                                </div>
                            </div>
                            {/* Board 2 */}
                            <div className="relative group overflow-hidden rounded-md shadow-lg">
                                <img src="/aboutpage/image_11.png" alt="Olivia Nyirandende" className="w-full aspect-[4/5] object-cover group-hover:scale-105 transition-transform duration-700" />
                                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent opacity-80 group-hover:opacity-100 transition-opacity duration-300" />
                                <div className="absolute bottom-6 left-6 right-6 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                                    <p className="text-[#c9a84c] text-[9px] uppercase tracking-[0.15em] font-extrabold mb-1" style={{ fontFamily: "'Lato', sans-serif" }}>BOARD MEMBER</p>
                                    <p className="text-white text-[17px] font-medium" style={{ fontFamily: "'Lato', sans-serif" }}>Olivia Nyirandende</p>
                                </div>
                            </div>
                            {/* Board 3 */}
                            <div className="relative group overflow-hidden rounded-md shadow-lg">
                                <img src="/aboutpage/image_12.png" alt="Edwin Kamanzi" className="w-full aspect-[4/5] object-cover group-hover:scale-105 transition-transform duration-700" />
                                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent opacity-80 group-hover:opacity-100 transition-opacity duration-300" />
                                <div className="absolute bottom-6 left-6 right-6 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                                    <p className="text-[#c9a84c] text-[9px] uppercase tracking-[0.15em] font-extrabold mb-1" style={{ fontFamily: "'Lato', sans-serif" }}>BOARD MEMBER</p>
